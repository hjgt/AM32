...
#define HARDWARE_GROUP_CH_A
 ...
 #define FIRMWARE_NAME "FD6288-G431"
#define FILE_NAME "CUSTOM_FD6288_G431"
#define MCU_G431
// Input: PB5 = TIM3_CH2 (AF2), telemetry: PB6 = USART1 (AF7)
...
// ---- ADC-based software ZCD ----
// PA0=ADC1_IN1 (BEMF A), PA1=ADC1_IN2 (BEMF B), PA2=ADC1_IN3 (BEMF C).
// Hardware COMP ZCD is not usable for a shared-neutral 6-step scheme on
// this layout: PA2 is not a plus input on any comparator, and the PA5
...
#define PHASE_C_COMP        LL_COMP_INPUT_MINUS_IO1
#define PHASE_C_INPUT_PLUS  LL_COMP_INPUT_PLUS_IO1
#define PHASE_C_EXTI_LINE   LL_EXTI_LINE_22
#define PHASE_C_COMP_NUMBER COMP2

// PWM outputs: TIM1 CH1/2/3 (PA8/9/10 AF6) high-side, CH1N/2N/3N (PA11/PA12/PF0 AF6) low-side
